...
from models.memae_3dconv2 import AutoEncoderCov3DMem
...
if (args.ModelName == 'AE'):
    ...
    model = AutoEncoderCov3DMem(16,16,[64, 128, 256, 512])
...
for epoch in range(args.epochs):
    ...
    for batch_idx, frame in enumerate(progress_bar):
        ...
        input_frame = torch.rand(4, 16, 256, 256)
        for b in range(4):
            total_pseudo_prob = 0
            ...
            if pseudo_bool:
                ...
                cls_labels.append(1)
        input_frame = input_frame.view(4, 16, 256, 256)
        # input_frame = input_frame.view(4, 1, 16, 256, 256)
